...
run.name              <- "anim_circle250_nicherate0.015_dispersal1_250gens_v2"
...
environment.source    <- "~/Work/Software/dan-github/DREaD_extras/circular250.asc"  # 'internal to generate in the code
